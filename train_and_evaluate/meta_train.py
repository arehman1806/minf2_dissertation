...
# )
model = PPO("MlpPolicy", env, verbose=1, batch_size=64, n_steps=64, tensorboard_log="./logs/meta")
model.learn(total_timesteps=4000, log_interval=10, tb_log_name=tb_log_name, callback=checkpoint_callback, progress_bar=True)
